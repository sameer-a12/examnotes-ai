  ...
  const fetchNotes = async (searchTerm = '') => {
    try {
      ...
      const res = await axios.get(
        serverUrl + `/api/notes/getnotes${searchTerm ? `?search=${searchTerm}` : ''}`,
      ...
      <div className='grid grid-cols-1 lg:grid-cols-4 gap-6'>
          ...
          {isSidebarOpen && (
            <motion.div
              ...
              className='fixed lg:static top-0 left-0 z-50 lg:z-auto
                w-72 lg:w-auto h-full lg:h-[75vh] lg:rounded-3xl lg:col-span-1
                bg-black/90 lg:bg-black/80 backdrop-blur-xl border border-white/10
                shadow-[0_20px_45px_rgba(0,0,0,0.6)] p-5 overflow-y-auto'
            >
              ...
              <div className='mb-4 space-y-1'>
                ...
                <h2 className='mb-3 text-lg font-bold bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent'>
                  📚 Your Notes
                </h2>
                ...
                <div className='relative mb-4'>
                  <input
                    ...
                    className='w-full px-3 py-2 rounded-xl text-sm
                      ...
                      placeholder-gray-500 outline-none focus:border-white/30 transition'
                  />
                  {searching && (
        ...
        <motion.div
          ...
          className='lg:col-span-3 rounded-2xl bg-white
            shadow-[0_15px_40px_rgba(0,0,0,0.15)] p-6 min-h-[75vh]'
        >
